    ...
    <PageLayout actions={headerActions}>
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-8">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold font-display text-lasalle-dark mb-2">
            Feed de Publicaciones
          </h1>
          <p className="text-slate-600">
            Comparte y descubre publicaciones de tu comunidad académica
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
          <div>
            <label htmlFor="subject-select" className="block text-sm font-semibold text-slate-700 mb-3">
              Filtrar por Materia
            </label>
            <select
              id="subject-select"
